...
int main()
{
    ...
    b = 2;
    n = 1000000;
    cout << "Метод трапеций = " << trapeciy(a, b, n) << endl;
    cout << "Метод Симпсона = " << sympson(a, b, n) << endl;

    int i;
    double Integral; // интеграл
    double h = 0.0001;
    n = (b - a) / h; // задаём число разбиений n (от этого зависит точность приближения)
    ...
    cout << "По методу трапеций = " << Integral << endl;
    ...
    cout << "По формуле Симпсона = " << Integral << endl;
